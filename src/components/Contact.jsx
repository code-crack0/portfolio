...
export default function Contact() {
  ...
  return (
    <section className="">
      <div className="py-8 lg:py-16 px-4 max-w-[1450px]">
        
        <h2 className="text-4xl max-w-[1450px] text-white font-bold mb-4 mx-auto p-8">Contact Me</h2>
        <p className="mb-8 lg:mb-8 font-light text-gray-500 dark:text-gray-400 sm:text-xl italic pl-8">Please reach out if you have any questions. I will get back to you at the earliest.</p>
        ...
        {showSuccessMessage && (
          ...
          <button type="submit" className="py-3 px-5 ml-8 text-sm font-medium text-center text-white rounded-lg bg-cyan-700 sm:w-fit focus:ring-4 focus:outline-none ">Send message</button>
        </form>
      </div>
    </section>
  );
