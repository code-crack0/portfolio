...
export default function Contact() {
  ...
  return (
    <section className="p-8">
      <div className=" lg:py-16 px-4 max-w-[2150px]">
        
        <h2 className="text-4xl max-w-[1450px] text-white font-bold mb-2 mx-auto p-8">Contact Me</h2>
       <form action="#" className="space-y-8 p-8" onSubmit={sendEmail}>
       <p className="mb-8 lg:mb-8 font-light text-gray-500 dark:text-gray-400 sm:text-xl italic">Please reach out if you have any questions. I will get back to you at the earliest.</p>
